...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('global.site_name', ['en' => 'My Website', 'uk' => 'Мій Вебсайт']);
        $this->migrator->add('global.meta_description', ['en' => 'Welcome to our website', 'uk' => 'Ласкаво просимо на наш вебсайт']);
        $this->migrator->add('global.logo', '');
        $this->migrator->add('global.favicon', '');
        $this->migrator->add('global.contact_email', 'contact@example.com');
        $this->migrator->add('global.feedback_form_title', ['en' => 'Feedback Form', 'uk' => 'Форма зворотного зв’язку']);
        $this->migrator->add('global.feedback_form_description', ['en' => 'Please share your feedback with us', 'uk' => 'Будь ласка, поділіться вашими відгуками']);
