                    ...
                    @if (!empty($settings->main_comparison_image) && is_string($settings->main_comparison_image))
                        <div class="relative w-full mt-6">
                            <img src="{{ Storage::url($settings->main_comparison_image) }}"
                                 ...
                                 class="object-fill w-full min-h-50  aspect-[4.13] max-md:max-w-full"/>
                            <span
                                class="absolute top-0 left-0 right-0 bottom-0 z-10 flex flex-col justify-center items-center leading-none text-center whitespace-nowrap h-full"
        ...
        <section class="home-about-section relative container  mx-auto px-2 py-10" id="about-us" role="main"
            ...
            <div class="home-about-us-grid ">
                ...
                <header class="grid-about w-full max-md:w-full max-md:max-w-none">
                    ...
                    <div class="mt-5 text-2xl text-white max-md:text-base max-md:w-full" style="">
