    ...
    <div class="container mx-auto">
        ...
        <div class=" px-2 mx-auto pt-40">
            ...
            <section
                ...
                <div
                    class="grid grid-cols-[repeat(auto-fit,minmax(160px,1fr))] max-md:grid-cols-2 max-sm:grid-cols-2 gap-1 w-full">
            ...
            <div class="flex flex-wrap gap-2 mt-5 w-full font-semibold leading-6 text-white max-md:max-w-full"
                ...
                @foreach ($settings->tender_items[app()->getLocale()] ?? [] as $item)
                    <article
                        ...
                        <svg width="384" height="211" viewBox="0 0 384 211" fill="none" xmlns="http://www.w3.org/2000/svg"
